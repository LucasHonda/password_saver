...
public class SwipeToDeleteCallback extends ItemTouchHelper.SimpleCallback {
    ...
    public SwipeToDeleteCallback(lucashonda.com.br.password_saver.adapter.adapterService adapterService) {
        ...
        deleteDrawable = ContextCompat.getDrawable(mAdapter.getContext(), R.drawable.delete);
